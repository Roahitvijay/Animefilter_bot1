...
START_MSG = environ.get("START_MSG", Animefilter.DEFAULT_MSG)
BOT_PICS = (environ.get('PICS', 'https://telegra.ph/file/7d23ca06e1a36a18cd85f.jpg')).split()
SUPPORT = environ.get("SUPPORT", "t.me/Animechannel90")
SPELL_MODE = is_enabled((environ.get('SPELL_MODE', "on")), True)
SET_SPEL_M = environ.get("SPELL_MODE_TEXT", Animefilter.SPELL_CHECK)
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", None))
DATABASE_URI = environ.get("DATABASE_URI", None)
FORCE = environ.get('FORCES_SUB')
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", Animefilter.FILE_CAPTIONS)
DEV_NAME = environ.get("DEV_NAME", "R0ahit")
